        ...
        <div className="cont">
            <section className="about-section">
                ...
                <div className="content">
                    <h2>About Us</h2>
                    <p>Welcome to GRAMURJA, a non-profit organization dedicated to the holistic development and empowerment of rural communities. Our key initiatives, GRAMUDYAM and GRAMHUNAR, are designed to address the unique challenges faced by rural populations, particularly in the areas of education, entrepreneurship, and community development.</p>
                </div>
            </section>
